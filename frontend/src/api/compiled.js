...
export const cluster = $root.cluster = (() => {
    ...
    cluster.UpdateRequest = (function() {

        /**
         * Properties of an UpdateRequest.
         * @memberof cluster
         * @interface IUpdateRequest
         * @property {number|null} [id] UpdateRequest id
         * @property {string|null} [kube_config] UpdateRequest kube_config
         * @property {string|null} [namespace] UpdateRequest namespace
         */
         ...
         * @constructor
         * @param {cluster.IUpdateRequest=} [properties] Properties to set
         */
         ...
         * UpdateRequest id.
         * @member {number} id
         * @memberof cluster.UpdateRequest
         * @instance
         */
        UpdateRequest.prototype.id = $util.Long ? $util.Long.fromBits(0,0,false) : 0;

        /**
         * UpdateRequest kube_config.
         * @member {string} kube_config
         * @memberof cluster.UpdateRequest
         * @instance
         */
        UpdateRequest.prototype.kube_config = "";

        /**
         * UpdateRequest namespace.
         * @member {string} namespace
         * @memberof cluster.UpdateRequest
         * @instance
         */
        UpdateRequest.prototype.namespace = "";

        /**
         * Encodes the specified UpdateRequest message. Does not implicitly {@link cluster.UpdateRequest.verify|verify} messages.
         * @function encode
         * @memberof cluster.UpdateRequest
         * @static
         * @param {cluster.UpdateRequest} message UpdateRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {cluster.UpdateRequest} UpdateRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UpdateRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cluster.UpdateRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        UpdateRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/cluster.UpdateRequest";
        };

        return UpdateRequest;
    })();

    cluster.UpdateResponse = (function() {
         ...
         * @constructor
         * @param {cluster.IUpdateResponse=} [properties] Properties to set
         */
        ...
        /**
         * Encodes the specified UpdateResponse message. Does not implicitly {@link cluster.UpdateResponse.verify|verify} messages.
         * @function encode
         * @memberof cluster.UpdateResponse
         * @static
         * @param {cluster.UpdateResponse} message UpdateResponse message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {cluster.UpdateResponse} UpdateResponse
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UpdateResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cluster.UpdateResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        UpdateResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/cluster.UpdateResponse";
        };
    ...
    cluster.ClusterSvc = (function() {
        ...
        /**
         * Callback as used by {@link cluster.ClusterSvc#update}.
         * @memberof cluster.ClusterSvc
         * @typedef UpdateCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {cluster.UpdateResponse} [response] UpdateResponse
         */
         ...
         * @memberof cluster.ClusterSvc
         * @instance
         * @param {cluster.UpdateRequest} request UpdateRequest message or plain object
         * @param {cluster.ClusterSvc.UpdateCallback} callback Node-style callback called with the error, if any, and UpdateResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(ClusterSvc.prototype.update = function update(request, callback) {
            return this.rpcCall(update, $root.cluster.UpdateRequest, $root.cluster.UpdateResponse, request, callback);
        }, "name", { value: "Update" });
         ...
         * @instance
         * @param {cluster.UpdateRequest} request UpdateRequest message or plain object
         * @returns {Promise<cluster.UpdateResponse>} Promise
         * @variation 2
         */
...
export const container = $root.container = (() => {
    ...
    container.Item = (function() {
         ...
         * @property {google.protobuf.Timestamp|null} [created_at] Item created_at
         */
         ...
         * @instance
         */
        Item.prototype.created_at = null;
...
export const model = $root.model = (() => {
    ...
    model.ClusterModel = (function() {
         ...
         * @property {string|null} [namespace] ClusterModel namespace
         */
        ...
        /**
         * ClusterModel namespace.
         * @member {string} namespace
         * @memberof model.ClusterModel
         * @instance
         */
        ClusterModel.prototype.namespace = "";
