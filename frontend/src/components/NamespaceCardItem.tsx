    ...
    <div className="project-detail">
      ...
      <DraggableModal
        ...
        title={
          <Badge.Ribbon
            ...
            placement="start"
            text={<>{item.namespace}<span style={{fontSize: 10, paddingLeft: 5, color: "#93c5fd"}}>({item.cluster_name})</span></>}
          >
      ...
      >
        <Tabs
          ...
          style={{ height: "100%" }}
        >
          <TabPane tab="logs" key="container-logs">
            <TabLog
              cardId={item.id}
          ...
          <TabPane tab="terminal" key="shell" style={{ height: "100%" }}>
