...
func RegisterMetricsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MetricsServer) error {
	...
	mux.Handle("GET", pattern_Metrics_TopPod_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/metrics.Metrics/TopPod", runtime.WithHTTPPathPattern("/api/metrics/clusters/{cluster_id}/namespace/{namespace}/pods/{pod}"))
		if err != nil {
...
func RegisterMetricsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MetricsClient) error {
	...
	mux.Handle("GET", pattern_Metrics_TopPod_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/metrics.Metrics/TopPod", runtime.WithHTTPPathPattern("/api/metrics/clusters/{cluster_id}/namespace/{namespace}/pods/{pod}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Metrics_StreamTopPod_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/metrics.Metrics/StreamTopPod", runtime.WithHTTPPathPattern("/api/metrics/clusters/{cluster_id}/namespace/{namespace}/pods/{pod}/stream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Metrics_TopPod_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"api", "metrics", "clusters", "cluster_id", "namespace", "pods", "pod"}, ""))

	pattern_Metrics_StreamTopPod_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"api", "metrics", "clusters", "cluster_id", "namespace", "pods", "pod", "stream"}, ""))
)
