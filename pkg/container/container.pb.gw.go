...
func request_ContainerSvc_Proxy_0(ctx context.Context, marshaler runtime.Marshaler, client ContainerSvcClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ContainerSvc_Proxy_0(ctx context.Context, marshaler runtime.Marshaler, server ContainerSvcServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ProxyRequest
	var metadata runtime.ServerMetadata
...
func RegisterContainerSvcHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ContainerSvcServer) error {
	...
	mux.Handle("POST", pattern_ContainerSvc_Proxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/container.ContainerSvc/Proxy", runtime.WithHTTPPathPattern("/api/containers/proxies/clusters/{cluster_id}/namespaces/{namespace}/pods/{pod}/ports/{port}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ContainerSvc_Proxy_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ContainerSvc_Proxy_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterContainerSvcHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ContainerSvcClient) error {
	...
	mux.Handle("POST", pattern_ContainerSvc_Proxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/container.ContainerSvc/Proxy", runtime.WithHTTPPathPattern("/api/containers/proxies/clusters/{cluster_id}/namespaces/{namespace}/pods/{pod}/ports/{port}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ContainerSvc_Proxy_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ContainerSvc_Proxy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7, 1, 0, 4, 1, 5, 8, 2, 9, 1, 0, 4, 1, 5, 10}, []string{"api", "containers", "proxies", "clusters", "cluster_id", "namespaces", "namespace", "pods", "pod", "ports", "port"}, ""))
)
...
var (
	...
	forward_ContainerSvc_Proxy_0 = runtime.ForwardResponseMessage
)
