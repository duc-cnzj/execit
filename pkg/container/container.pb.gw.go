...
func RegisterContainerSvcHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ContainerSvcServer) error {
	...
	mux.Handle("POST", pattern_ContainerSvc_Proxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/container.ContainerSvc/Proxy", runtime.WithHTTPPathPattern("/api/containers/proxies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterContainerSvcHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ContainerSvcClient) error {
	...
	mux.Handle("POST", pattern_ContainerSvc_Proxy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/container.ContainerSvc/Proxy", runtime.WithHTTPPathPattern("/api/containers/proxies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_ContainerSvc_Proxy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "containers", "proxies"}, ""))
)
