...
func request_FileSvc_ShowRecords_0(ctx context.Context, marshaler runtime.Marshaler, client FileSvcClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_FileSvc_ShowRecords_0(ctx context.Context, marshaler runtime.Marshaler, server FileSvcServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ShowRecordsRequest
	var metadata runtime.ServerMetadata
...
func RegisterFileSvcHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FileSvcServer) error {
	...
	mux.Handle("GET", pattern_FileSvc_ShowRecords_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/file.FileSvc/ShowRecords", runtime.WithHTTPPathPattern("/api/record_files/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FileSvc_ShowRecords_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_FileSvc_ShowRecords_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFileSvcHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileSvcClient) error {
	...
	mux.Handle("GET", pattern_FileSvc_ShowRecords_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/file.FileSvc/ShowRecords", runtime.WithHTTPPathPattern("/api/record_files/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FileSvc_ShowRecords_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_FileSvc_ShowRecords_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"api", "record_files", "id"}, ""))
...
var (
	...
	forward_FileSvc_ShowRecords_0 = runtime.ForwardResponseMessage
